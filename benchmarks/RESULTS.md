...
This was the retained head before the `_OP_PREPCALLK` one-argument default-delegate natclosure fast path was promoted. Its authoritative six-workload total was `286.094 ms`.
